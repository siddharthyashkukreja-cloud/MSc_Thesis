...
The fundamental value $V_t$ is exogenously created and fed as a signal to FV traders. By default, the fundamental value is taken as the empirical mid price series for E-mini (ES) futures. A synthetic GBM with jumps and a mean reverting volatility process is kept as an alternative, and both lead to a realistic reproduction of stylised facts.
